...
bool searchInBST(Node* root, int target) {
  ...
  return leftAns || rightAns;// Yeh statement left aur right subtrees ki recursive calls ke natije ka logical OR karti hai (||). Agar left ya right subtree mein se koi bhi desired value wala node ho, toh result true hoga see lc 
}
